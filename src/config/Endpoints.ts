...
import {OsSession, OsSessionApiType} from "../types/session";
...
export const Endpoints = {
    ...
    openSpaceSession: (session: OsSessionApiType) => new URL(session.identifier, Endpoints.openSpaceImages(session.os_identifier)).href,
}
